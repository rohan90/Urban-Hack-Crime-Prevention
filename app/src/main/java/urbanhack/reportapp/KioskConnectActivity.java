...
public class KioskConnectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kiosk_connect);
        initBle();
    }
...
//                displayData(intent.getByteArrayExtra(RBLService.EXTRA_DATA));
    ...
    private void sendReportTItle() {
        String author = SharedPreferenceUtil.getInstance(this).getData("name","Unknown");
        String names[] = author.split(" ");
        String str = "Welcome "+names[0]+"!";
